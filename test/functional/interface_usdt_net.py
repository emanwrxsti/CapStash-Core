...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/CapStash/CapStash/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(CapStashTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our CapStashd node")
