...
class SettingsTest(CapStashTestFramework):
    ...
    def run_test(self):
        ...
        conf = node.datadir_path / "CapStash.conf"

        # Assert default settings file was created
        self.stop_node(0)
        default_settings = {"_warning_": "This file is automatically generated and updated by CapStash Core. Please do not edit this file while the node is running, as any changes might be ignored or overwritten."}
