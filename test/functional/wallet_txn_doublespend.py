...
class TxnMallTest(CapStashTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 Cap:
        ...
        # First: use raw transaction API to send 1240 Cap to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 Cap coin each
        ...
        # Node0's balance should be starting balance, plus 50Cap for another
        ...
        # Node0's total balance should be starting balance, plus 100Cap for
