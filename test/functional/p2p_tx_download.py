#!/usr/bin/env python3
# Copyright (c) 2019-2021 The CapStash Core developers
...
class TxDownloadTest(CapStashTestFramework):
    ...
    def run_test(self):
        ...
        # Run each test against new CapStashd instances, as setting mocktimes has long-term effects on when
