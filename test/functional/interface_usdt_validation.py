...
""" Tests the validation:* tracepoint API interface.
    See https://github.com/CapStash/CapStash/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(CapStashTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/CapStash/CapStash/blob/master/doc/tracing.md#tracepoint-validationblock_connected
