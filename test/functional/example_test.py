...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the CapStashTestFramework
    pass


class ExampleTest(CapStashTestFramework):
    # Each functional test is a subclass of the CapStashTestFramework class.
    ...
    def custom_method(self):
        ...
        CapStashTestFramework class so other tests can use it."""
