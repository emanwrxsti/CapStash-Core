...
class WalletTest(CapStashTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 Cap from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 Cap with subtract fee from amount
        ...
        # Sendmany 10 Cap with subtract fee from amount
        ...
        # Sendmany 5 Cap to two addresses with subtracting fee from both addresses
        ...
        if not self.options.descriptors:
            ...
            # This will raise an exception for attempting to get the private key of an invalid CapStash address
            assert_raises_rpc_error(-5, "Invalid CapStash address", self.nodes[0].dumpprivkey, "invalid")

            # This will raise an exception for attempting to set a label for an invalid CapStash address
            assert_raises_rpc_error(-5, "Invalid CapStash address", self.nodes[0].setlabel, "invalid address", "label")

            # This will raise an exception for importing an invalid address
            assert_raises_rpc_error(-5, "Invalid CapStash address or script", self.nodes[0].importaddress, "invalid")
