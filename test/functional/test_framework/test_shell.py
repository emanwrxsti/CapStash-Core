...
class TestShell:
    """Wrapper Class for CapStashTestFramework.

    The TestShell class extends the CapStashTestFramework
    ...
    class __TestShell(CapStashTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by CapStashTestFramework child class.
            self.num_nodes = 1
