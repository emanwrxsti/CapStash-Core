...
"""
Test starting CapStashd with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(CapStashTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that CapStashd has bound on "::1" (for RPC) and "::" (for P2P).
