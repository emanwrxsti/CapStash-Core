...
Verify that a CapStashd node can use an external signer command.
...
class RPCSignerTest(CapStashTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart CapStashd with -signer=<cmd>',
