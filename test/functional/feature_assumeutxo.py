#!/usr/bin/env python3
# Copyright (c) 2021-present The CapStash Core developers
...
to a hash that has been compiled into CapStashd.
...
class AssumeutxoTest(CapStashTestFramework):
    ...
    def test_invalid_mempool_state(self, dump_output_path):
        self.log.info("Test CapStashd should fail when mempool not empty.")
        node=self.nodes[2]
