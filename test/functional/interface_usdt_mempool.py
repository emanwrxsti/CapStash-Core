...
"""  Tests the mempool:* tracepoint API interface.
     See https://github.com/CapStash/CapStash/blob/master/doc/tracing.md#context-mempool
"""
...
class MempoolTracepointTest(CapStashTestFramework):
    ...
    def rejected_test(self):
        ...
        # https://github.com/CapStash/CapStash/issues/27380
