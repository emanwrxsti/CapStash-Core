...
By default, CapStashd will dump mempool on shutdown and
...
class MempoolPersistTest(CapStashTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent CapStashd from writing mempool.dat to disk. Verify that `savemempool` fails")
