...
"""Example logging CapStash Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/CapStashd
...
def main(CapStashd_path):
    ...
    b = BPF(text=program, usdt_contexts=[CapStashd_with_usdts])
