...
complete --command CapStash-qt --no-files

# Extract options
function __fish_CapStashqt_get_options
...
complete \
    --command CapStash-qt \
    --arguments "(__fish_CapStashqt_get_options --nofiles)"
