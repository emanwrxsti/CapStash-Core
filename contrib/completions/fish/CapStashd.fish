...
complete --command CapStashd --no-files

# Extract options
function __fish_CapStashd_get_options
...
complete \
    --command CapStashd \
    --arguments "(__fish_CapStashd_get_options --nofiles)"
