...
# Extract options
function __fish_CapStash_tx_get_options
...
# Extract commands
function __fish_CapStash_tx_get_commands
...
complete \
    --command CapStash-tx \
    --condition "not __fish_CapStash_seen_cmd (__fish_CapStash_tx_get_commands --commandsonly)" \
    --arguments "(__fish_CapStash_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command CapStash-tx \
    --arguments "(__fish_CapStash_tx_get_commands)" \
    --no-files
