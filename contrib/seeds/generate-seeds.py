...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef CAPSTASH_CHAINPARAMSSEEDS_H\n')
    g.write('#define CAPSTASH_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the CapStash network\n')
    ...
    g.write('#endif // CAPSTASH_CHAINPARAMSSEEDS_H\n')
