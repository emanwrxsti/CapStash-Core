...
(define* (make-CapStash-cross-toolchain target
                                       #:key
...
desirable for building CapStash Core release binaries."
...
;; failure; see https://github.com/CapStash/CapStash/pull/27296.
  ...
  (let ((target (getenv "HOST")))
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list (make-CapStash-cross-toolchain target)))
