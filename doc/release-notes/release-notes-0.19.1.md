...
CapStash Core version 0.19.1 is now available from:

  <https://CapStashcore.org/bin/CapStash-core-0.19.1/>
...
From CapStash Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as CapStash Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, CapStash Core does not yet change appearance when
...
- #17488 fix "CapStashd already running" warnings on macOS (fanquake)
