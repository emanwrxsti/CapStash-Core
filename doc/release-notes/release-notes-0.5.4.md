CapStash version 0.5.4 is now available for download at:
http://sourceforge.net/projects/CapStash/files/CapStash/CapStash-0.5.4/
...
http://gitorious.org/CapStash/CapStashd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix CapStash-Qt notifications under Growl 1.3.
Increase required age of CapStash-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxCapStash properly when installing CapStash-Qt over it. (Windows)
