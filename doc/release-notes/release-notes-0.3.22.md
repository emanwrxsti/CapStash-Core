Download URL: https://sourceforge.net/projects/CapStash/files/CapStash/CapStash-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 Cap fee schedule (users still pay 0.01 Cap per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #CapStash00 - #CapStash99
