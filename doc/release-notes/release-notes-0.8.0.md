CapStash-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/CapStash/files/CapStash/CapStash-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the CapStash
...
New/changed settings (command-line or CapStash.conf file)
--------------------------------------------------------
