CapStash Core version *0.15.2* is now available from:

  <https://CapStashcore.org/bin/CapStash-core-0.15.2/>
...
CapStash Core versions 0.14.0 up to 0.16.2. It is recommended to upgrade any of
...
- #11554 `a69cc07` Sanity-check script sizes in CapStash-tx (TheBlueMatt)
