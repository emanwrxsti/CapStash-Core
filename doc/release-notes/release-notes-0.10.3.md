CapStash Core version 0.10.3 is now available from:

  <https://CapStash.org/bin/CapStash-core-0.10.3/>
...
(see https://github.com/CapStash/CapStash/pull/6793, as well as the 0.11.0
