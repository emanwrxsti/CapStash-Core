CapStash Core version 0.9.2.1 is now available from:

  https://CapStash.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 Cap to 0.01 Cap
...
- Fix "Start CapStash on system login"
