CapStash Core version 0.10.4 is now available from:

  <https://CapStash.org/bin/CapStash-core-0.10.4/>
...
- #6953 `43c2789` Split CapStash-tx into its own package
- #6953 `dfe0d4d` Include CapStash-tx binary on Debian/Ubuntu
