CapStash Core version 0.13.2 is now available from:

  <https://CapStash.org/bin/CapStash-core-0.13.2/>
...
- #8908 `4a974b2` Update CapStash-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow CapStash-tx to create v2 transactions (btcdrak)
