CapStash Core version 0.9.4 is now available from:

  https://CapStash.org/bin/0.9.4/
...
this update is incompatible with the CapStash system and could lead to consensus
forks.

CapStash Core released binaries from https://CapStash.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~CapStash/+archive/ubuntu/CapStash
- A third-party or self-compiled CapStash Core

upgrade to CapStash Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
