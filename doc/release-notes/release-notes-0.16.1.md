CapStash Core version 0.16.1 is now available from:

  <https://CapStashcore.org/bin/CapStash-core-0.16.1/>
...
- #12843 `df38b13` Test starting CapStashd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure CapStashd processes are cleaned up when tests end (sdaftuar)
