...
This document provides guidelines for internationalization of the CapStash Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `CapStash_en.ts` remains unchanged.
