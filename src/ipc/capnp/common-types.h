...
#ifndef CAPSTASH_IPC_CAPNP_COMMON_TYPES_H
#define CAPSTASH_IPC_CAPNP_COMMON_TYPES_H
...
//! Functions to serialize / deserialize common CapStash types.
namespace mp {
...
#endif // CAPSTASH_IPC_CAPNP_COMMON_TYPES_H
