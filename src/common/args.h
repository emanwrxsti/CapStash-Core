...
#ifndef CAPSTASH_COMMON_ARGS_H
#define CAPSTASH_COMMON_ARGS_H
...
extern const char * const CAPSTASH_CONF_FILENAME;
extern const char * const CAPSTASH_SETTINGS_FILENAME;
