...
#ifndef CAPSTASH_PROTOCOL_H
#define CAPSTASH_PROTOCOL_H
...
/**
 * CapStash protocol message types. When adding new message types, don't forget
...
enum ServiceFlags : uint64_t {
    ...
    // set by all CapStash Core non pruned nodes, and is unset by SPV clients or other light clients.
    NODE_NETWORK = (1 << 0),
    ...
    // CapStash-development mailing list. Remember that service bits are just
