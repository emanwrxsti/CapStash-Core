...
#ifndef CAPSTASH_RPC_UTIL_H
#define CAPSTASH_RPC_UTIL_H
...
/**
 * Parse a json number or string, denoting Cap/kvB, into a CFeeRate (sat/kvB).
 * Reject negative values or rates larger than 1Cap/kvB.
 */
