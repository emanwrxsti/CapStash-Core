...
#ifndef CAPSTASH_RPC_PROTOCOL_H
#define CAPSTASH_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in CapStashd
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< CapStash is not connected
