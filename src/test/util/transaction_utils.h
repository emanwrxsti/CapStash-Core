// Copyright (c) 2019-2020 The CapStash Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef CAPSTASH_TEST_UTIL_TRANSACTION_UTILS_H
#define CAPSTASH_TEST_UTIL_TRANSACTION_UTILS_H
...
#endif // CAPSTASH_TEST_UTIL_TRANSACTION_UTILS_H
