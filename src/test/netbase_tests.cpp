...
{
    BOOST_CHECK(TestSplitHost("www.CapStashcore.org", "www.CapStashcore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.CapStashcore.org]", "www.CapStashcore.org", 0));
    BOOST_CHECK(TestSplitHost("www.CapStashcore.org:80", "www.CapStashcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.CapStashcore.org]:80", "www.CapStashcore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.CapStashcore.org:65536", "www.CapStashcore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.CapStashcore.org:0", "www.CapStashcore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.CapStashcore.org:", "www.CapStashcore.org:", 0, false));
}
