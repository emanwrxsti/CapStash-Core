...
#ifndef CAPSTASH_TEST_SCRIPTNUM10_H
#define CAPSTASH_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from CapStash Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // CAPSTASH_TEST_SCRIPTNUM10_H
