...
#ifndef CAPSTASH_QT_CAPSTASHGUI_H
#define CAPSTASH_QT_CAPSTASHGUI_H
...
/**
  CapStash GUI main class. This class represents the main window of the CapStash UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class CapStashGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit CapStashGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~CapStashGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a CapStash wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
private:
    ...
    QWidget* m_theme_toggle_widget = nullptr;
    QLabel* m_theme_toggle_label = nullptr;
    QToolButton* m_theme_classic_button{nullptr};
    QToolButton* m_theme_green_button = nullptr;
    QToolButton* m_theme_amber_button = nullptr;

    void createThemeToggle();
    void updateThemeToggleState();
    void setThemeMode(PipBoyTheme::Mode mode);
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, CapStashUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed CapStash Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(CapStashUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // CAPSTASH_QT_CAPSTASHGUI_H
