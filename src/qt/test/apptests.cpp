...
//! Entry point for CapStashApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &CapStashApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for CapStashGUI tests.
void AppTests::guiTests(CapStashGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &CapStashGUI::consoleShown, this, &AppTests::consoleTests);
