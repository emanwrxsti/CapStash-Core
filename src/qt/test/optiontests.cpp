...
{
    // Test regression https://github.com/CapStash/CapStash/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/CapStash-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/CapStash-core/gui/pull/568.
    // With fListen=false in ~/.config/CapStash/CapStash-Qt.conf and all else left as default,
    // CapStash-qt should set both -listen and -listenonion to false and start successfully.
