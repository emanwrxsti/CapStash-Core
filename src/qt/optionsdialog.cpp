      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->CapStashAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->CapStashAtStartup);
    ...
    ui->CapStashAtStartup->setToolTip(ui->CapStashAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->CapStashAtStartup->setText(ui->CapStashAtStartup->text().arg(PACKAGE_NAME));

    ui->openCapStashConfButton->setToolTip(ui->openCapStashConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new CapStashUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->CapStashAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSCapontrols);
...
void OptionsDialog::on_openCapStashConfButton_clicked()
{
