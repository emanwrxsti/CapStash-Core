...
#ifndef CAPSTASH_QT_OPTIONSMODEL_H
#define CAPSTASH_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for CapStash client.
...
public:
    ...
    CapStashUnit getDisplayUnit() const { return m_display_CapStash_unit; }
    QString getThirdPartyTxUrls() const { return strThirdPartyTxUrls; }
    QFont getFontForMoney() const;
    bool getCoinControlFeatures() const { return fCoinControlFeatures; }
    bool getSubFeeFromAmount() const { return m_sub_fee_from_amount; }
    bool getEnablePSCapontrols() const { return m_enable_psbt_controls; }
...
private:
    ...
    QString language;
    CapStashUnit m_display_CapStash_unit;
...
Q_SIGNALS:
    void displayUnitChanged(CapStashUnit unit);
...
#endif // CAPSTASH_QT_OPTIONSMODEL_H
