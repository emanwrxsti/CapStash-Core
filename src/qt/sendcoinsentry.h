...
#ifndef CAPSTASH_QT_SENDCOINSENTRY_H
#define CAPSTASH_QT_SENDCOINSENTRY_H
...
/**
 * A single entry in the dialog for sending CapStashs.
 */
...
#endif // CAPSTASH_QT_SENDCOINSENTRY_H
