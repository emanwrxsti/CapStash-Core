...
#ifndef CAPSTASH_QT_GUIUTIL_H
#define CAPSTASH_QT_GUIUTIL_H
...
/** Utility functions used by the CapStash Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "CapStash:" URI into recipient object, return true on successful parsing
