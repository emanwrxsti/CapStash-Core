...
#ifndef CAPSTASH_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define CAPSTASH_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // CAPSTASH_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
