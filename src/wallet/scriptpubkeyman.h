...
#ifndef CAPSTASH_WALLET_SCRIPTPUBKEYMAN_H
#define CAPSTASH_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The CapStash Core wallet was originally a collection of unrelated private
...
#endif // CAPSTASH_WALLET_SCRIPTPUBKEYMAN_H
