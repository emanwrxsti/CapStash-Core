...
#ifndef CAPSTASH_WALLET_WALLET_H
#define CAPSTASH_WALLET_WALLET_H
...
public:
     ...
     * CapStash-wallet tool code or by wallet migration code. If this is called
...
#endif // CAPSTASH_WALLET_WALLET_H
