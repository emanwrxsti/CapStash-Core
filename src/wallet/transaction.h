...
#ifndef CAPSTASH_WALLET_TRANSACTION_H
#define CAPSTASH_WALLET_TRANSACTION_H
...
public:
     ...
     * on this CapStash node, and set to 0 for transactions that were created
...
#endif // CAPSTASH_WALLET_TRANSACTION_H
