// Copyright (c) 2017-2021 The CapStash Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef CAPSTASH_WALLET_WALLETUTIL_H
#define CAPSTASH_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! CapStash from opening the wallet, thinking it was newly created, and
...
#endif // CAPSTASH_WALLET_WALLETUTIL_H
