...
//! @file
//! @brief Common init functions shared by CapStash-node, CapStash-wallet, etc.

#ifndef CAPSTASH_INIT_COMMON_H
#define CAPSTASH_INIT_COMMON_H
