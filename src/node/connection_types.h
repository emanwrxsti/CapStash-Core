...
#ifndef CAPSTASH_NODE_CONNECTION_TYPES_H
#define CAPSTASH_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/CapStash-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on CapStash’s Peer-to-Peer Network")
...
#endif // CAPSTASH_NODE_CONNECTION_TYPES_H
