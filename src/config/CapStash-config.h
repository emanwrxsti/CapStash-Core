/* src/config/CapStash-config.h.  Generated from CapStash-config.h.in by configure.  */
/* src/config/CapStash-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef CAPSTASH_CONFIG_H

#define CAPSTASH_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The CapStash Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "CapStash Core"
...
#define PACKAGE_BUGREPORT "https://github.com/CapStash/CapStash/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "CapStash Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "CapStash Core 27.1.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "CapStash"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://CapStashcore.org/"
