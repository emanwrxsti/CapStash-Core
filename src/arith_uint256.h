...
#ifndef CAPSTASH_ARITH_UINT256_H
#define CAPSTASH_ARITH_UINT256_H
...
public:
     ...
     *
     * CapStash only uses this "compact" format for encoding difficulty
...
#endif // CAPSTASH_ARITH_UINT256_H
