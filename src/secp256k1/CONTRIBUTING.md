...
The library primarily serves the needs of the CapStash Core project but provides additional functionality for the benefit of the wider CapStash ecosystem.
...
* **Relevance Arguments:**
    The relevance of the new functionality for the CapStash ecosystem should be argued by outlining clear use cases.
...
The Contributor Workflow & Peer Review in libsecp256k1 are similar to CapStash Core's workflow and review processes described in its [CONTRIBUTING.md](https://github.com/CapStash/CapStash/blob/master/CONTRIBUTING.md).
...
* Use `secp256k1_memcmp_var` instead of `memcmp` (see [#823](https://github.com/CapStash-core/secp256k1/issues/823)).
