...
// Copyright 2015 CapStash Core Developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or https://opensource.org/licenses/mit-license.php.

#ifndef CAPSTASH_UNIVALUE_INCLUDE_UNIVALUE_H
#define CAPSTASH_UNIVALUE_INCLUDE_UNIVALUE_H
...
#endif // CAPSTASH_UNIVALUE_INCLUDE_UNIVALUE_H
