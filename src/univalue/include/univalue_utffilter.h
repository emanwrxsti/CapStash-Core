...
#ifndef CAPSTASH_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
#define CAPSTASH_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
...
#endif // CAPSTASH_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
