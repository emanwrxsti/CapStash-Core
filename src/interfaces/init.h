...
#ifndef CAPSTASH_INTERFACES_INIT_H
#define CAPSTASH_INTERFACES_INIT_H
...
//! (CapStash-gui, CapStash-node, CapStash-wallet, CapStashd, CapStash-qt) and each
...
#endif // CAPSTASH_INTERFACES_INIT_H
