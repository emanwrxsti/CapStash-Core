...
#ifndef CAPSTASH_INTERFACES_NODE_H
#define CAPSTASH_INTERFACES_NODE_H
...
//! Top-level interface for a CapStash node (CapStashd process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or CapStash.conf.
...
#endif // CAPSTASH_INTERFACES_NODE_H
